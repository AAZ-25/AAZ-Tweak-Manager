...
- Imports backups from Files or the iOS share sheet, then accepts them only after protected local staging and integrity validation. Duplicate archives are rejected.
