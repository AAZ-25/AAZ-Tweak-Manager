...
- Lets Files select any document, then accepts it only after protected local staging and backup-integrity validation. Import status stays privacy-safe and duplicate archives are rejected.
