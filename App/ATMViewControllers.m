...
- (void)importBackup { UTType *backupType = [UTType typeWithIdentifier:@"com.aaz.tweakmanager.backup"]; NSArray<UTType *> *types = backupType ? @[backupType, UTType.data] : @[UTType.data]; UIDocumentPickerViewController *picker = [[UIDocumentPickerViewController alloc] initForOpeningContentTypes:types asCopy:YES]; picker.delegate = self; picker.allowsMultipleSelection = NO; [self presentViewController:picker animated:YES completion:nil]; }
